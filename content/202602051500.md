...
出典: [Use API Gateway Lambda authorizers](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-use-lambda-authorizer.html)
...
- [Canaryリリースを試してみる](https://github.com/trkoh/AWS/tree/main/APIGateway/canary-deployment)
...
出典: [Set up an API Gateway canary release deployment](https://docs.aws.amazon.com/apigateway/latest/developerguide/canary-release.html)
